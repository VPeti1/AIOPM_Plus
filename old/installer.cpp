...
void dw() {
    ...
    if (distro == "arch") {
        ...
        system("sudo wget https://raw.githubusercontent.com/VPeti1/AIOPM_Plus/main/old/arch.cpp -O /usr/aiopmi/pm.cpp");
    }
    else if (distro == "debian") {
        system("sudo apt-get install git wget build-essential");
        system("sudo wget https://raw.githubusercontent.com/VPeti1/AIOPM_Plus/main/old/debian.cpp -O /usr/aiopmi/pm.cpp");
    }
    else if (distro == "fedora") {
        system("sudo dnf install git wget gcc-c++");
        system("sudo wget https://raw.githubusercontent.com/VPeti1/AIOPM_Plus/main/old/fedora.cpp -O /usr/aiopmi/pm.cpp");
    }
    else if (distro == "suse") {
        system("sudo zypper install git wget gcc-c++");
        system("sudo wget https://raw.githubusercontent.com/VPeti1/AIOPM_Plus/main/old/suse.cpp -O /usr/aiopmi/pm.cpp");
    }
    else if (distro == "void") {
        system("sudo xbps-install git wget gcc");
        system("sudo wget https://raw.githubusercontent.com/VPeti1/AIOPM_Plus/main/old/void.cpp -O /usr/aiopmi/pm.cpp");
    }
     else {
